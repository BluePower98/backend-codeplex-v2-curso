  ...
  <div style="background-color:#e0f2ff;">
    ...
    <div style="background:#2a5cab;background-color:#2a5cab;margin:0px auto;max-width:600px;">
      <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation"
        style="background:#2a5cab;background-color:#ff7700;width:100%;">
        <tbody>
          <tr>
                          ...
                          <tr>
                            <td align="center" style="font-size:0px;padding:10px 30px;word-break:break-word;">
                              <div
                                ...
                                <strong> Hola {{ $user->nombre }}, has solcitado recuperar tu contraseña, por motivos de seguriad
                                     se generó una contraseña temporal, la cual le recomendamos cambiar a la brevedad. </strong>
                                <br><br>
                                ...
                                <p style="color: black;">
                                  ...
                                  <a href="{{ $redirect_url }}"
                                     style="background-color: #36b0c0; border: none; color: white; padding: 12px; text-align: center;
